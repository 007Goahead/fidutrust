...
const FormulesSocietes = () => {
  ...
  const formulas = [{
    ...
    annualPrice: 1188,
    invoices: '120',
    ideal: t('formulas.youngCompany'),
    features: [t('formulas.accountingEntry'), t('formulas.vatDeclarations'), t('formulas.annualAccounts'), t('formulas.deadlineTracking')]
  }, {
    name: t('formulas.standard'),
    monthlyPrice: 239,
    annualPrice: 2388,
    invoices: '250',
    ideal: t('formulas.growingPME'),
    popular: true,
    features: [t('formulas.allEssentialPlus'), t('formulas.isocDeclarations'), t('formulas.basicTaxAdvice'), t('formulas.uboRegister')]
  }, {
    name: t('formulas.advanced'),
    monthlyPrice: 359,
    annualPrice: 3588,
    invoices: '375',
    ideal: t('formulas.establishedStructure'),
    features: [t('formulas.allStandardPlus'), t('formulas.taxOptimization'), t('formulas.cashManagement'), t('formulas.financialPlans')]
  }, {
    name: t('formulas.premium'),
    monthlyPrice: 599,
    annualPrice: 5988,
    invoices: '500',
    ideal: t('formulas.intenseActivity'),
  ...
  return <section id="formules-societes" className="py-20 px-5 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-serif text-[#0D1B2A] text-center mb-4">
          {t('formulas.companiesTitle')}
        </h2>
        ...
        <div className="text-center space-y-4">
          <p className="text-gray-600" data-mixed-content="true">
            {t('formulas.customQuote')} | {t('formulas.companyCreation')} : <strong className="text-[#C6A664]">2.300 € HT</strong>
          </p>
...
export default FormulesSocietes;